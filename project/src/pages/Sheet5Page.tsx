...
const Sheet5Page: React.FC = () => {
  return (
    <div>
      <h1>Première page de tests</h1>
      <section className="page-section">
        <h2>Cette page est dédiée aux tests</h2>
        <p className="mb-6">
          Pour le moment je commence à peine à me failiariser avec ce type de programmation, donc je n'ai pas encore de tests à vous montrer.:
        </p>
        <p className="mb-6">
          Je vais essayer de faire des tests pour les composants, les pages, et les hooks que j'ai créés.
        </p>
        <p className="mb-6">
          Je vais aussi essayer de faire des tests pour les fonctionnalités que j'ai implémentées,
          comme la navigation entre les pages, l'affichage des données, et la gestion des états.
        </p>
        <p className="mb-6">
          Je vais aussi essayer de faire des tests pour les erreurs que j'ai rencontrées,
          comme les erreurs de syntaxe, les erreurs de logique, et les erreurs de runtime.
        </p>
      </section>
